...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Perfect Theme Switcher</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
      <link rel="stylesheet" href="/css/bs-5/<?php echo $theme->getTheme(); ?>/bootstrap.css">
  ...
  <body>
    <div class="navbar navbar-expand-lg fixed-top navbar-dark bg-primary">
      <div class="container">
        <a href="#" class="navbar-brand">Perfect Theme Switcher</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="themes">
                <a class="dropdown-item" href="?theme=default/">Default</a>
                ...
                <a class="dropdown-item" href="?theme=morph">Morph</a>
                <a class="dropdown-item" href="?theme=pulse">Pulse</a>
                <a class="dropdown-item" href="?theme=quartz">Quartz</a>
                ...
                <a class="dropdown-item" href="?theme=vapor">Vapor</a>
                <a class="dropdown-item" href="?theme=yeti">Yeti</a>
                <a class="dropdown-item" href="?theme=zephyr">Zephyr</a>
              </div>
            </li>

            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" id="download">Dropdown</a>
              <div class="dropdown-menu" aria-labelledby="download">
                <a class="dropdown-item" rel="noopener" target="_blank" href="#">Link</a>
                <div class="dropdown-divider"></div>
          ...
          <ul class="navbar-nav ms-md-auto">
            ...
            <li class="nav-item">
              <a target="_blank" rel="noopener" class="nav-link" href="#"><i class="bi bi-twitter"></i> Twitter</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="page-header" id="banner">
        <div class="row">
          <div class="col-lg-8 col-md-7 col-sm-6">
            <h1><?php echo ucfirst($theme->getTheme()); ?></h1>
